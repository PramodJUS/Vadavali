...
const languages = {
    sa: {
        title: 'वादावली - Sri Jayatirtha\'s Treatise on Dvaita Vedanta',
        adhyaya: 'अध्यायः:',
        pada: 'पादः:',
        adhikarana: 'अधिकरणम्:',
        allTopics: 'सर्वम्',
        ...
        infoText: 'वादावली (Vādāvalī) is a philosophical treatise by <strong>Sri Jayatirtha</strong>, presenting key arguments and refutations related to <strong>Dvaita Vedanta</strong> philosophy. This presentation includes commentaries by <strong>Raghavendra Tirtha</strong> (भावदीपा) and <strong>Srinivasa Tirtha</strong> (प्रकाशः).',
        ...
        noResults: 'No topics found for the selected criteria.',
        footer: 'वादावली by Sri Jayatirtha with commentaries by Raghavendra Tirtha and Srinivasa Tirtha | For educational purposes',
        sutraLabel: 'विषयः',
        adhyayaNames: {
            '1': 'प्रथमाध्यायः',
            '2': 'द्वितीयाध्यायः',
    ...
    kn: {
        ...
        title: 'ವಾದಾವಲಿ - ಜಯತೀರ್ಥರ ದ್ವೈತ ವೇದಾಂತ ಗ್ರಂಥ',
        allTopics: 'ಎಲ್ಲಾ ವಿಷಯಗಳು',
        searchPlaceholder: 'ವಿಷಯಗಳನ್ನು ಹುಡುಕಿ...',
        infoText: 'ವಾದಾವಲಿ (वादावली) ಶ್ರೀ ಜಯತೀರ್ಥರು ರಚಿಸಿದ ದ್ವೈತ ವೇದಾಂತದ ಪ್ರಮುಖ ಗ್ರಂಥವಾಗಿದೆ. ಇದು ಅದ್ವೈತ ವೇದಾಂತದ ಮಿಥ್ಯಾತ್ವವಾದವನ್ನು ಖಂಡಿಸಿ <strong>ಭೇದವಾದವನ್ನು</strong> ಸ್ಥಾಪಿಸುತ್ತದೆ.',
        backToList: '← ಪಟ್ಟಿಗೆ ಹಿಂತಿರುಗಿ',
        backToHome: 'ಮುಖ್ಯ ಪುಟ',
        references: 'ಉಲ್ಲೇಖಗಳು:',
        loading: 'ವಿಷಯಗಳನ್ನು ಲೋಡ್ ಮಾಡಲಾಗುತ್ತಿದೆ...',
        noResults: 'ಆಯ್ದ ಮಾನದಂಡಕ್ಕಾಗಿ ಯಾವುದೇ ವಿಷಯಗಳು ಕಂಡುಬಂದಿಲ್ಲ.',
        footer: 'ಜಯತೀರ್ಥರ ವಾದಾವಲಿ ಮತ್ತು ವ್ಯಾಖ್ಯಾನಗಳು | ಶೈಕ್ಷಣಿಕ ಉದ್ದೇಶಗಳಿಗಾಗಿ',
    ...
    te: {
        ...
        title: 'వాదావలి - జయతీర్థుల ద్వైత వేదాంత గ్రంథం',
        allTopics: 'అన్ని విషయాలు',
        searchPlaceholder: 'విషయాలను వెతకండి...',
        infoText: 'వాదావలి (वादावली) శ్రీ జయతీర్థులు రచించిన ద్వైత వేదాంతం యొక్క ప్రముఖ గ్రంథం. ఇది అద్వైత వేదాంతం యొక్క మిథ్యాత్వవాదాన్ని ఖండించి <strong>భేదవాదాన్ని</strong> స్థాపిస్తుంది.',
        backToList: '← జాబితాకు తిరిగి వెళ్ళండి',
        backToHome: 'ముఖ్య పేజీ',
        references: 'సూచనలు:',
        loading: 'విషయాలు లోడ్ అవుతున్నాయి...',
        noResults: 'ఎంచుకున్న ప్రమాణాల కోసం విషయాలు కనుగొనబడలేదు.',
        footer: 'జయతీర్థుల వాదావలి మరియు వ్యాఖ్యానాలు | విద్యా ప్రయోజనాల కోసం',
    ...
    ta: {
        ...
        title: 'வாதாவலி - ஜயதீர்த்தரின் த்வைத வேதாந்த நூல்',
        allTopics: 'அனைத்து தலைப்புகள்',
        searchPlaceholder: 'தலைப்புகளைத் தேடு...',
        infoText: 'வாதாவலி (वादावली) ஸ்ரீ ஜயதீர்த்தரால் இயற்றப்பட்ட த்வைத வேதாந்தத்தின் முக்கிய நூலாகும். இது அத்வைத வேதாந்தத்தின் மித்யாத்வ வாதத்தை மறுத்து <strong>பேதவாதத்தை</strong> நிறுவுகிறது.',
        backToList: '← பட்டியலுக்குத் திரும்பு',
        backToHome: 'முகப்பு பக்கம்',
        references: 'குறிப்புகள்:',
        loading: 'தலைப்புகள் ஏற்றப்படுகின்றன...',
        noResults: 'தேர்ந்தெடுக்கப்பட்ட அளவுகோல்களுக்கு தலைப்புகள் இல்லை.',
        footer: 'ஜயதீர்த்தரின் வாதாவலி மற்றும் விளக்கங்கள் | கல்வி நோக்கங்களுக்காக',
        adhyayaExplanations: {
            '1': 'சமன்வய',
            '2': 'அவிரோத',
            '3': 'சாதன',
    ...
    ml: {
        ...
        title: 'വാദാവലി - ജയതീര്‍ഥരുടെ ദ്വൈത വേദാന്ത ഗ്രന്ഥം',
        allTopics: 'എല്ലാ വിഷയങ്ങളും',
        searchPlaceholder: 'വിഷയങ്ങൾ തിരയുക...',
        infoText: 'വാദാവലി (वादावली) ശ്രീ ജയതീര്‍ഥര്‍ രചിച്ച ദ്വൈത വേദാന്തത്തിന്റെ പ്രധാന ഗ്രന്ഥമാണ്. <strong>ദ്വൈത (ദ്വന്ദ്വാത്മക) വേദാന്ത</strong> തത്ത്വചിന്തയുടെ കേന്ദ്ര തത്ത്വങ്ങള്‍ അവതരിപ്പിക്കുന്നു.',
        backToList: '← പട്ടികയിലേക്ക് മടങ്ങുക',
        backToHome: 'മുഖ്യ പേജ്',
        references: 'അവലംബങ്ങൾ:',
        loading: 'വിഷയങ്ങൾ ലോഡ് ചെയ്യുന്നു...',
        noResults: 'തിരഞ്ഞെടുത്ത മാനദണ്ഡങ്ങൾക്ക് വിഷയങ്ങളൊന്നും കണ്ടെത്തിയില്ല.',
        footer: 'ജയതീര്‍ഥരുടെ വാദാവലിയും വ്യാഖ്യാനങ്ങളും | വിദ്യാഭ്യാസ ആവശ്യങ്ങൾക്ക്'
    },
    gu: {
        // Gujarati UI translations
        title: 'વાદાવલી - જયતીર્થના દ્વૈત વેદાંત ગ્રંથ',
        allTopics: 'બધા વિષયો',
        searchPlaceholder: 'વિષયો શોધો...',
        infoText: 'વાદાવલી (वादावली) શ્રી જયતીર્થ દ્વારા રચિત દ્વૈત વેદાંતનો મુખ્ય ગ્રંથ છે. <strong>દ્વૈત (દ્વૈતવાદી) વેદાંત</strong> તત્ત્વજ્ઞાનના મૂળ સિદ્ધાંતો રજૂ કરે છે.',
        backToList: '← યાદી પર પાછા ફરો',
        backToHome: 'મુખ્ય પૃષ્ઠ',
        references: 'સંદર્ભો:',
        loading: 'વિષયો લોડ થઈ રહ્યા છે...',
        noResults: 'પસંદ કરેલા માપદંડો માટે કોઈ વિષયો મળ્યા નથી.',
        footer: 'જયતીર્થના વાદાવલી અને ભાષ્યો | શૈક્ષણિક હેતુઓ માટે'
    },
    or: {
        // Odia UI translations
        title: 'ବାଦାବଲୀ - ଜୟତୀର୍ଥଙ୍କ ଦ୍ୱୈତ ବେଦାନ୍ତ ଗ୍ରନ୍ଥ',
        allTopics: 'ସମସ୍ତ ବିଷୟ',
        searchPlaceholder: 'ବିଷୟଗୁଡିକ ଖୋଜନ୍ତୁ...',
        infoText: 'ବାଦାବଲୀ (वादावली) ଶ୍ରୀ ଜୟତୀର୍ଥଙ୍କ ଦ୍ୱାରା ରଚିତ ଦ୍ୱୈତ ବେଦାନ୍ତର ମୁଖ୍ୟ ଗ୍ରନ୍ଥ। <strong>ଦ୍ୱୈତ (ଦ୍ୱୈତବାଦୀ) ବେଦାନ୍ତ</strong> ଦର୍ଶନର ମୂଳ ସିଦ୍ଧାନ୍ତଗୁଡିକ ଉପସ୍ଥାପନ କରେ।',
        backToList: '← ତାଲିକାକୁ ଫେରନ୍ତୁ',
        backToHome: 'ମୁଖ୍ୟ ପୃଷ୍ଠା',
        references: 'ସନ୍ଦର୍ଭ:',
        loading: 'ବିଷୟଗୁଡିକ ଲୋଡ୍ ହେଉଛି...',
        noResults: 'ମନୋନୀତ ମାନଦଣ୍ଡ ପାଇଁ କୌଣସି ବିଷୟ ମିଳିଲା ନାହିଁ।',
        footer: 'ଜୟତୀର୍ଥଙ୍କ ବାଦାବଲୀ ଏବଂ ଭାଷ୍ୟଗୁଡିକ | ଶିକ୍ଷାଗତ ଉଦ୍ଦେଶ୍ୟ ପାଇଁ'
    },
    bn: {
        // Bengali UI translations
        title: 'বাদাবলী - জয়তীর্থের দ্বৈত বেদান্ত গ্রন্থ',
        allTopics: 'সমস্ত বিষয়',
        searchPlaceholder: 'বিষয় খুঁজুন...',
        infoText: 'বাদাবলী (वादावली) শ্রী জয়তীর্থ রচিত দ্বৈত বেদান্তের প্রধান গ্রন্থ। <strong>দ্বৈত (দ্বৈতবাদী) বেদান্ত</strong> দর্শনের মূল নীতিগুলি উপস্থাপন করে।',
        backToList: '← তালিকায় ফিরে যান',
        backToHome: 'মুখ্য পৃষ্ঠা',
        references: 'তথ্যসূত্র:',
        loading: 'বিষয় লোড হচ্ছে...',
        noResults: 'নির্বাচিত মানদণ্ডের জন্য কোনো বিষয় পাওয়া যায়নি।',
        footer: 'জয়তীর্থের বাদাবলী এবং ভাষ্যসমূহ | শিক্ষাগত উদ্দেশ্যে'
    },
    en: {
        // English UI translations (no transliteration, just English UI)
        title: 'Vādāvalī - Sri Jayatirtha\'s Treatise on Dvaita Vedanta',
        adhyaya: 'Chapter:',
        pada: 'Section:',
        adhikarana: 'Topic:',
        ...
        infoText: 'Vādāvalī is a philosophical treatise by <strong>Sri Jayatirtha</strong>, presenting key arguments and refutations related to <strong>Dvaita Vedanta</strong> philosophy. This presentation includes commentaries by <strong>Raghavendra Tirtha</strong> (Bhāvadīpā) and <strong>Srinivasa Tirtha</strong> (Prakāśa).',
...
const topicList = document.getElementById('sutraList');
const topicDetail = document.getElementById('sutraDetail');
...
const previousHeaderBtn = document.getElementById('previousTopicHeaderBtn');
const nextHeaderBtn = document.getElementById('nextTopicHeaderBtn');
...
function makePratikaGrahanaBold(text, vyakhyanaNum = null) {
    // Skip pratika grahana formatting for वादावली (source text - num 0)
    if (vyakhyanaNum === 0 || vyakhyanaNum === '0') {
        return text;
    }
...
function setupEventListeners() {
    ...
    // adhikaranaSelect removed from UI
    searchInput.addEventListener('input', debounce(searchSutras, 300));
    sectionHeading.addEventListener('click', toggleTopicList);
    ...
    if (vyakhyanaDropdownBtn && vyakhyanaDropdownContent) {
        ...
        checkboxes.forEach(checkbox => {
            checkbox.addEventListener('change', () => {
                updateSelectedVyakhyanas();
                if (currentView === 'detail' && currentTopic) {
...
function navigateVyakhyanaPage(sutraNum, vyakhyaKey, direction, event, shouldScroll = false) {
    ...
    console.log('📄 navigateVyakhyanaPage called:', { sutraNum, vyakhyaKey, paginationKey, direction });
    ...
    console.log('📄 Found elements:', { commentaryItem: !!commentaryItem, contentElement: !!contentElement });

    if (!contentElement) {
        console.error('❌ Content element not found for pagination key:', paginationKey);
        return;
    }
    ...
    console.log('📄 Navigating to page:', newPage, 'Total pages:', totalPages);
    console.log('📄 Page content length:', pages[newPage]?.length || 0);

    // Update content with pratika grahana bold formatting
    const pageContent = pages[newPage].replace(/<PB>/gi, '').replace(/\n/g, '<br>');
    const formattedContent = makePratikaGrahanaBold(pageContent, sutraNum);
    contentElement.innerHTML = formattedContent;

    console.log('📄 Content updated. innerHTML length:', contentElement.innerHTML.length);
...
function selectVyakhyanaPage(sutraNum, vyakhyaKey, pageIndex, event, shouldScroll = false) {
    ...
    // Update content with pratika grahana bold formatting
contentElement.innerHTML = makePratikaGrahanaBold(pages[pageIndex].replace(/<PB>/gi, '').replace(/\n/g, '<br>'), sutraNum);
...
function onLanguageChange() {
    ...
    if (currentView === 'list') {
        filterTopics();
    } else if (currentView === 'detail' && currentTopic) {
    ...
    if (adhikaranaPopup && adhikaranaPopup.style.display === 'flex' && currentTopic) {
        showAdhikaranaInfo(currentTopic);
    }
    
    // Refresh personal notes popup if it's open
    const personalNotesModal = document.getElementById('personalNotesModal');
    if (personalNotesModal && currentTopic) {
        closePersonalNotes();
        showPersonalNotes(currentTopic);
    }
}
...
// Navigate to previous topic (outer << button - preserves open vyakhyanas like old Previous button)
function navigateToPreviousVyakhyana() {
    if (!currentTopic || filteredTopics.length === 0) return;
    
    const currentIndex = filteredTopics.findIndex(s =>
        currentTopic.adhyaya ?
            (s.adhyaya === currentTopic.adhyaya && s.pada === currentTopic.pada && s.sutra_number === currentTopic.sutra_number) :
            (s.id === currentTopic.id)
    );
    ...
    if (currentIndex > 0) {
        ...
        showTopicDetail(previousTopic);
        
        // After navigation, open the same vyakhyanas (only if they exist in new topic) and scroll to first one
        setTimeout(() => {
            // Get available vyakhyanas for the new topic to check which ones exist
...
// Navigate to next topic (outer >> button - preserves open vyakhyanas like old Next button)
...
// Navigate to previous part within current topic (inner < button)
function navigateToPreviousPart() {
    ...
    if (partKeys.length === 0) {
        console.log('No parts found in this topic');
        return;
    }
    ...
    if (currentPartIndex > 0) {
        ...
        if (currentIndex > 0) {
            const previousTopic = filteredTopics[currentIndex - 1];
            const prevSutraKey = previousTopic.adhyaya ? `${previousTopic.adhyaya}.${previousTopic.pada}.${previousTopic.sutra_number}` : previousTopic.id;
            const prevDetails = topicDetails[prevSutraKey] || {};
            
            // Get last part of previous topic
...
// Navigate to next part within current topic (inner > button)
...
function updateNavigationButtons() {
    ...
    const previousBtn = document.getElementById('previousTopicHeaderBtn');
    const nextBtn = document.getElementById('nextTopicHeaderBtn');
    const prevVyakhyanaBtn = document.getElementById('prevVyakhyanaBtn');
    const nextVyakhyanaBtn = document.getElementById('nextVyakhyanaBtn');
    const prevPartBtn = document.getElementById('prevPartBtn');
    const nextPartBtn = document.getElementById('nextPartBtn');
    ...
    if (nextBtn) {
        nextBtn.disabled = currentIndex >= filteredTopics.length - 1;
    }
    
    // Check if we're on the first topic (1.1.1)
    const isFirstSutra = currentTopic.adhyaya == 1 && 
                        currentTopic.pada == 1 && 
                        currentTopic.sutra_number == 1;
    ...
    const isLastSutra = currentIndex >= filteredTopics.length - 1;
    
    // Debug logging
    console.log('Navigation Debug:', {
        sutra: currentTopic.adhyaya ? `${currentTopic.adhyaya}.${currentTopic.pada}.${currentTopic.sutra_number}` : currentTopic.id,
    ...
    // < button disabled only when on first topic AND first part
    if (prevPartBtn) {
        prevPartBtn.disabled = isFirstSutra && isFirstPart;
        prevPartBtn.style.opacity = (isFirstSutra && isFirstPart) ? '0.3' : '1';
    }
    // > button disabled only when on last topic AND last part
    if (nextPartBtn) {
    ...
    // Disable if on first topic (regardless of part)
    if (prevVyakhyanaBtn) {
    ...
    // Disable if on last topic (regardless of part)
    if (nextVyakhyanaBtn) {
...
// Update vyakhyana dropdown based on available vyakhyanas for current topic
function updateVyakhyanaDropdownForSutra(availableVyakhyanas) {
    ...
    if (selectAllVyakhyanas) {
        ...
        // Keep only selections that are still available in the new topic
...
async function loadTopics() {
    try {
        ...
        try {
            const authorResponse = await fetch('Grantha/Author.csv');
        ...
        // Load CSV data
        const csvResponse = await fetch('Grantha/mainpage.csv');
        const csvText = await csvResponse.text();
        allTopics = parseCSV(csvText);

        const timestamp = new Date().getTime();

        // Load JSON details with cache-busting
        try {
            const jsonResponse = await fetch(`Grantha/grantha-details.json?v=${timestamp}`);
            topicDetails = await jsonResponse.json();
        } catch (jsonError) {
        ...
        try {
            const adhikaranaResponse = await fetch(`Grantha/vishaya-details.json?v=${timestamp}`);
...
function populateAdhikaranaDropdown() {
    // Skip if adhikarana dropdown doesn't exist (removed from UI)
    if (!adhikaranaSelect) return;
    ...
    // If adhyaya/pada don't exist (simple CSV), show all topics
    const adhikaranas = [...new Set(
        allTopics
            .filter(sutra => !sutra.adhyaya || (sutra.adhyaya === selectedAdhyaya && sutra.pada === selectedPada))
...
function filterTopics() {
    const selectedAdhyaya = adhyayaSelect.value;
    const selectedPada = padaSelect.value;
    const selectedAdhikarana = adhikaranaSelect ? adhikaranaSelect.value : 'all';

    filteredTopics = allTopics.filter(sutra => {
        // If adhyaya/pada don't exist (simple CSV structure), show all sutras
        const matchesAdhyayaPada = !sutra.adhyaya || (sutra.adhyaya === selectedAdhyaya && sutra.pada === selectedPada);
    ...
    displaySutras(filteredTopics);
}

// Update section heading with Sanskrit names
function updateSectionHeading(adhyaya, pada) {
    const headingText = 'विषयानुक्रमणिका';
    sectionTitle.textContent = currentLanguage !== 'sa' ?
                               transliterateText(headingText, currentLanguage) :
                               headingText;
}
...
function searchSutras() {
    ...
    const searchResults = allTopics.filter(sutra => {
...
function displaySutras(sutras) {
    ...
    const html = sutras.map((sutra, index) => createTopicLink(sutra, index)).join('');
    ...
    document.querySelectorAll('.sutra-link').forEach((link, index) => {
        link.addEventListener('click', (e) => {
            e.preventDefault();
            showTopicDetail(sutras[index]);
        });
    });
}

// Create a clickable sutra link
function createTopicLink(sutra, index) {
    ...
    return `
        <a href="#" class="sutra-link" data-index="${index}">
            ...
            ${adhikaranaText ? `<div class="sutra-link-adhikarana">${adhikaranaText}</div>` : ''}
            <div class="arrow">→</div>
        </a>
    `;
}
...
function updateInfoPanelForTopic(sutra) {
    ...
    const topicKey = sutra.adhyaya ? `${sutra.adhyaya}.${sutra.pada}.${sutra.sutra_number}` : sutra.id;
    ...
    setTimeout(() => {
        ...
        const vishayaLink = document.getElementById('vishayaInfoLink');
        if (vishayaLink) {
            vishayaLink.addEventListener('click', () => {
                showVishayaInfo(sutra);
            });
        }
...
function restoreInfoPanel() {
    ...
    // Add vishaya info link if in detail view
    const vishayaLinkHTML = currentView === 'detail' && currentTopic ?
        `<p style="margin-top: 15px;">
            <span class="vishaya-info-link" onclick="showVishayaInfo(currentTopic)">
                View Topic Details
            </span>
        </p>` : '';
    ...
    infoPanelContent.innerHTML = `
        <h2>वादावली</h2>
        <p class="info-text">
            Vadavali (वादावली) is a seminal philosophical text composed by <strong>Sri Jayatirtha</strong>
            (also known as Teeka Acharya), presenting the core principles of
            <strong>Dvaita (Dualistic) Vedanta</strong> philosophy.
        </p>
        ${vishayaLinkHTML}
        <div class="philosophy-box">
            <h3>द्वैत वेदान्त सिद्धान्ताः</h3>
            <ul>
...
function showTopicDetail(sutra, partKey = null) {
    ...
    currentView = 'detail';
    currentTopic = sutra; // Store current topic
    topicList.style.display = 'none';
    topicDetail.style.display = 'block';
    
    // Update info panel with sutra info
    updateInfoPanelForTopic(sutra);
    ...
    // Use simple ID if adhyaya doesn't exist (simple CSV structure)
    const topicKey = sutra.adhyaya ? `${sutra.adhyaya}.${sutra.pada}.${sutra.sutra_number}` : sutra.id;
    const details = topicDetails[topicKey] || {};
    ...
    // OR in simple structure: keys like 'भावदीपा', 'प्रकाशः' (not 'मूलम्')
    const excludeKeys = ['meaning', 'meaningKn', 'meaningTe', 'meaningDetails', 'meaningDetailsKn', 'meaningDetailsTe',
                         'commentary', 'commentaryKn', 'commentaryTe', 'मूलम्'];
    const vyakhyanaKeys = Object.keys(vyakhyanaContainer).filter(key => {
        if (excludeKeys.includes(key)) return false;
        const value = vyakhyanaContainer[key];
        // Handle both complex structure (object) and simple structure (string)
        if (!value) return false;
        if (typeof value === 'string') return true; // Simple structure: any string value is a vyakhyana
                ...
                return `
                    <div class="commentary-item" data-key="${vyakhyaKey}" ${authorAttr} data-pagination-key="${paginationKey}" data-vyakhyana-num="${num}" data-vyakhya-key="${vyakhyaKey}">
                        ...
                        <div class="commentary-content" id="commentary-${num}" style="display: none;">
                            ${resizeHandleTop}
                            ${watermarkDiv}
                            <p class="commentary-text" data-pages="${JSON.stringify(pages).replace(/"/g, '&quot;')}">${makePratikaGrahanaBold(pages[currentPage].replace(/<PB>/gi, '').replace(/\n/g, '<br>'), num)}</p>
    ...
    // Check if using simple structure (Part#1 with direct string properties)
    const isSimpleStructure = details['Part#1'] && typeof details['Part#1']['वादावली'] === 'string';

    if (isSimpleStructure) {
        // Simple rendering for Part-based structure with full features
        let simpleHTML = '';
        const partData = details[currentPart];
        const topicId = sutra.id || sutra.sutra_number;

        if (partData) {
            simpleHTML += `<div class="part-section"><div class="commentary-items">`;

            // Dynamically process ALL commentaries from partData
            const commentaries = [];
            let commentaryNum = 0;
            ...
            const sortedKeys = allKeys.sort((a, b) => {
                const aIndex = commentaryOrder.indexOf(a);
                const bIndex = commentaryOrder.indexOf(b);
            ...
            // Build commentaries array dynamically
            for (const key of sortedKeys) {
                const text = partData[key];
                if (!text || typeof text !== 'string') continue;

                // Get author info from authorMap (loaded from Author.csv)
                const authorInfo = authorMap[key];
                const authorImage = authorInfo && authorInfo.image ? authorInfo.image : '';
            ...
            // Update dropdown to include all commentaries (including मूलम्)
            const availableVyakhyanas = commentaries.map((c, index) => ({
                num: index + 1,
                key: c.key
            }));
            if (availableVyakhyanas.length > 0) {
                updateVyakhyanaDropdownForSutra(availableVyakhyanas);
            }

            // Render each commentary with full features
            commentaries.forEach(({ key, title, text, color, author, num }) => {
                const isVisible = selectedVyakhyanaKeys.has(key);
                if (!isVisible) return; // Skip if not selected in dropdown

                // Transliterate title and text if needed
                let transliteratedTitle = currentLanguage !== 'sa' ?
                                         transliterateText(title, currentLanguage) :
                                         title;
                let commentaryText = currentLanguage !== 'sa' ?
                                    transliterateText(text, currentLanguage) :
                                    text;
                ...
                if (totalPages > 1) {
                    radioButtons = '<div class="page-radio-group" onclick="event.stopPropagation()">';
                    for (let i = 0; i < totalPages; i++) {
                        radioButtons += `<input type="radio" class="page-radio" name="page-top-${paginationKey}" ${i === currentPage ? 'checked' : ''} onchange="selectVyakhyanaPage(${topicId}, '${key}', ${i}, event)" onclick="event.stopPropagation()" style="border-color: ${color}; --checked-bg: ${color};">`;
                    }
                    radioButtons += '</div>';
                }
                ...
                const paginationControls = totalPages > 1 ? `
                    <div class="pagination-controls" onclick="event.stopPropagation()">
                        <button class="pagination-prev" onclick="navigateVyakhyanaPage(${topicId}, '${key}', -1, event)" ${currentPage === 0 ? 'disabled' : ''} style="opacity: ${currentPage === 0 ? '0.3' : '1'}; color: ${color}; border-color: ${color};">‹</button>
                        <span class="pagination-info" style="color: ${color};">${currentPage + 1} / ${totalPages}</span>
                        <button class="pagination-next" onclick="navigateVyakhyanaPage(${topicId}, '${key}', 1, event)" ${currentPage === totalPages - 1 ? 'disabled' : ''} style="opacity: ${currentPage === totalPages - 1 ? '0.3' : '1'}; color: ${color}; border-color: ${color};">›</button>
                    </div>
                ` : '';
                ...
                if (totalPages > 1) {
                    bottomRadioButtons = '<div class="page-radio-group" onclick="event.stopPropagation()">';
                    for (let i = 0; i < totalPages; i++) {
                        bottomRadioButtons += `<input type="radio" class="page-radio" name="page-bottom-${paginationKey}" ${i === currentPage ? 'checked' : ''} onchange="selectVyakhyanaPage(${topicId}, '${key}', ${i}, event, true)" onclick="event.stopPropagation()" style="border-color: ${color}; --checked-bg: ${color};">`;
                    }
                    bottomRadioButtons += '</div>';
                }
                ...
                const bottomPaginationControls = totalPages > 1 ? `
                    <div class="bottom-pagination">
                        <span class="commentary-title" onclick="toggleCommentary(${num}, '${key}')" style="cursor: pointer; color: ${color};">${transliteratedTitle}</span>
                        ${bottomRadioButtons}
                        <div class="pagination-controls" onclick="event.stopPropagation()">
                            <button class="pagination-prev" onclick="navigateVyakhyanaPage(${topicId}, '${key}', -1, event, true)" ${currentPage === 0 ? 'disabled' : ''} style="opacity: ${currentPage === 0 ? '0.3' : '1'}; color: ${color}; border-color: ${color};">‹</button>
                            <span class="pagination-info" style="color: ${color};">${currentPage + 1} / ${totalPages}</span>
                            <button class="pagination-next" onclick="navigateVyakhyanaPage(${topicId}, '${key}', 1, event, true)" ${currentPage === totalPages - 1 ? 'disabled' : ''} style="opacity: ${currentPage === totalPages - 1 ? '0.3' : '1'}; color: ${color}; border-color: ${color};">›</button>
                        </div>
                    </div>
                ` : '';

                // Watermark
                const watermarkDiv = author ? `<div class="watermark lazy-bg" data-bg="images/${author}"></div>` : '';
                ...
                const searchBox = `
                    <div class="vyakhyana-search-box" onclick="event.stopPropagation()" style="display: inline-block; margin-left: 10px;">
                        <input type="text"
                               placeholder="🔍 Search..."
                               id="search-input-${num}-${key.replace(/[^a-zA-Z0-9]/g, '-')}"
                               data-vyakhyana-num="${num}"
                               data-vyakhya-key="${key}"
                               onclick="event.stopPropagation()"
                               oninput="getOrCreateDebouncedSearch('${num}', '${key}')(this.value)"
                               style="padding: 4px 8px; border: 1px solid #ccc; border-radius: 4px; font-size: 12px; width: 150px;">
                    </div>
                `;

                // Render commentary item with all features
                simpleHTML += `
                    <div class="commentary-item" data-key="${key}" data-pagination-key="${paginationKey}" data-vyakhyana-num="${num}" data-vyakhya-key="${key}" ${author ? `data-author="${author}"` : ''}>
                        <div class="commentary-header" onclick="toggleCommentary(${num}, '${key}')">
                            <span class="commentary-title" style="color: ${color};">${transliteratedTitle}</span>
                            ${radioButtons}
                            <span style="flex: 1;"></span>
                            ${searchBox}
                            ${paginationControls}
            ...
            simpleHTML = `<div style="padding: 20px; text-align: center; color: #666;">No content for ${currentPart}</div>`;
        }

        detailContent.innerHTML = simpleHTML;
    } else {
    ...
    // Restore open/closed state for commentaries
    setTimeout(() => {
        document.querySelectorAll('.commentary-item').forEach(item => {
            const key = item.dataset.key;
            const num = item.dataset.vyakhyanaNum;
            if (key && openVyakhyanas.has(key)) {
                const content = document.getElementById(`commentary-${num}`);
                const toggle = document.getElementById(`toggle-${num}`);
                if (content && toggle) {
                    content.style.display = 'block';
    ...
    setTimeout(() => {
        openVyakhyanas.forEach(vyakhyanaKey => {
            ...
            if (isSimpleStructure) {
                // Simple structure: match by key name (भावदीपा or प्रकाशः)
                const simpleKeys = [];
                if (details[currentPart]?.['भावदीपा']) simpleKeys.push('भावदीपा');
                if (details[currentPart]?.['प्रकाशः']) simpleKeys.push('प्रकाशः');
                num = simpleKeys.indexOf(vyakhyanaKey) + 1;
            } else {
                // Complex structure: find position in vyakhyana container
                const excludeKeys = ['meaning', 'meaningKn', 'meaningTe', 'meaningDetails', 'meaningDetailsKn', 'meaningDetailsTe',
                                     'commentary', 'commentaryKn', 'commentaryTe'];
                const vyakhyanaKeys = Object.keys(vyakhyanaContainer).filter(key => {
                    if (excludeKeys.includes(key)) return false;
                ...
                num = vyakhyanaKeys.indexOf(vyakhyanaKey) + 1;
            }
    ...
    setTimeout(() => {
        ...
        if (sutraAudioBtn) {
            sutraAudioBtn.addEventListener('click', () => {
                const audioFile = sutra.adhyaya ? `Grantha/audio/${sutra.adhyaya}.${sutra.pada}.${sutra.sutra_number}.mp3` : `Grantha/audio/${sutra.id}.mp3`;
    ...
    // Scroll to content area (not to very top)
    if (detailContent) {
...
function searchInVyakhyana(vyakhyanaNum, vyakhyaKey, searchTerm) {
    ...
    // NOT topicKey! vyakhyanaNum is the sequential number (1, 2, 3...)
...
function searchInVyakhyanaWithPratika(vyakhyanaNum, vyakhyaKey, searchTerm, isPratikaGrahana = false) {
    ...
    if (results.count > 0 && results.matches.length > 0) {
        ...
        const storageKey = `vyakhyana_${paginationKey}_page${currentPage}_original`;
...
function showLoading() {
    const lang = languages[currentLanguage];
    const baseLang = languages['sa'];
    topicList.innerHTML = `<div class="loading">${lang.loading || baseLang.loading}</div>`;
}

// Show error message
function showError(message) {
    topicList.innerHTML = `<div class="no-results">${message}</div>`;
}
...
function showNoResults() {
    const lang = languages[currentLanguage];
    const baseLang = languages['sa'];
    topicList.innerHTML = `<div class="no-results">${lang.noResults || baseLang.noResults}</div>`;
}
...
function playNextSutra() {
    if (!isPlayingSequence || currentPlaybackIndex >= filteredTopics.length) {
        stopSequentialPlayback();
        return;
    }
    ...
    const currentTopicLink = document.querySelectorAll('.sutra-link')[currentPlaybackIndex];
    if (currentTopicLink) {
        currentTopicLink.classList.add('playing');
        // Scroll into view
        currentTopicLink.scrollIntoView({ behavior: 'smooth', block: 'center' });
    }
    
    const repeatSelect = document.getElementById('repeatSelect');
    const maxRepeats = parseInt(repeatSelect?.value || '1');
    
    const sutra = filteredTopics[currentPlaybackIndex];
    const audioFile = sutra.adhyaya ? `Grantha/audio/${sutra.adhyaya}.${sutra.pada}.${sutra.sutra_number}.mp3` : `Grantha/audio/${sutra.id}.mp3`;
...
function showAdhikaranaInfo(sutra) {
    ...
    const sutrasInAdhikarana = allTopics.filter(s => 
        s.adhyaya === sutra.adhyaya && 
        s.pada === sutra.pada && 
        s.adhikarana === sutra.adhikarana
    );
    
    const topicList = sutrasInAdhikarana.map(s => {
        const isCurrent = s.sutra_number === sutra.sutra_number;
        const sutraText = currentLanguage !== 'sa' ? 
                         transliterateText(s.sutra_text, currentLanguage) : 
                         s.sutra_text;
        const numberDisplay = s.adhyaya ? `${s.adhyaya}.${s.pada}.${s.sutra_number}` : s.id;
        return `<li${isCurrent ? ' class="current-sutra"' : ''}>
            <strong>${numberDisplay}</strong> - ${sutraText}
        </li>`;
    }).join('');
...
async function updateLastModifiedDate() {
    ...
    try {
        ...
        updateDateElement.textContent = 'February 25, 2026';
    }
}
...
function showPersonalNotes() {
    ...
    if (!personalNotesKey) {
        alert('No personal notes available for this topic');
        return;
    }
...
// Show vishaya (topic) information popup
function showVishayaInfo(topic) {
    if (!topic || !topic.id) return;
    
    // Create popup overlay if it doesn't exist
    let popup = document.getElementById('vishayaPopup');
    if (!popup) {
        popup = document.createElement('div');
        popup.id = 'vishayaPopup';
        popup.className = 'vishaya-popup-overlay';
        document.body.appendChild(popup);
    }
    
    const topicText = currentLanguage !== 'sa' ? 
                      transliterateText(topic.sutra_text, currentLanguage) : 
                      topic.sutra_text;
    
    const vishayaLabel = currentLanguage !== 'sa' ? 
                         transliterateText('विषयः', currentLanguage) : 
                         'विषयः';
    
    // Get vishaya details from JSON
    let details = {};
    const topicId = String(topic.id); // Ensure ID is a string
    if (adhikaranaDetails && adhikaranaDetails[topicId]) {
        details = adhikaranaDetails[topicId];
    }

    console.log('Vishaya ID:', topicId);
    console.log('Available IDs in adhikaranaDetails:', adhikaranaDetails ? Object.keys(adhikaranaDetails) : 'not loaded');
    console.log('Vishaya details:', details);
    
    // Build details sections
    let detailsHTML = '';
    
    // Fields to skip
    const metadataFields = ['id', 'topic'];
    ...
    for (const [fieldKey, fieldValue] of Object.entries(details)) {
        ...
        const formattedValue = transliteratedValue.replace(/\n/g, '<br>');

        detailsHTML += `<div class="vishaya-detail-section">
    ...
    if (!detailsHTML) {
        detailsHTML = `<div class="vishaya-detail-section">
            <em>Details for this topic will be added soon.</em>
        </div>`;
    }
    
    popup.innerHTML = `
        <div class="vishaya-popup-content">
            <div class="vishaya-popup-header">
                <h3>${vishayaLabel}</h3>
                <button class="vishaya-popup-close" onclick="closeVishayaPopup()">&times;</button>
            </div>
            <div class="vishaya-popup-body">
                <div class="vishaya-name">${topicText}</div>
                <h4>Topic Details:</h4>
                ${detailsHTML}
            </div>
        </div>
...
function closeVishayaPopup() {
    const popup = document.getElementById('vishayaPopup');
    if (popup) {
        popup.style.display = 'none';
    }
}
...
window.showVishayaInfo = showVishayaInfo;
window.closeVishayaPopup = closeVishayaPopup;
